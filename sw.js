const CACHE='chen-honey-v1';
const CORE=['./','./index.html','./styles.css','./script.js','./manifest.webmanifest','./assets/app-icon.svg','./assets/hero-honey.png','./assets/natural-death.jpg','./assets/smart-hive.png'];
