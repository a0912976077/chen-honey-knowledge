const CACHE='chen-honey-v2';
const CORE=['./','./index.html','./admin.html','./styles.css','./admin.css','./script.js','./admin.js','./manifest.webmanifest','./assets/app-icon.svg','./assets/hero-honey.png','./assets/natural-death.jpg','./assets/smart-hive.png'];
